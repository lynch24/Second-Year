...
'''  This algorithm sorts on the priority  '''

def prior(list):                                                                                   # A function to sort the list.
   return int(list[1])                                                                             # Sorts the list at index one.
...
def hpf(tasks):
   ...
   for token in tasks:                                               
      priority.append(token.split(' '))                                                            # Splits list into tokens.
      process.append(token.split(' '))
   priority.sort(key=prior)                                                                        # Letting the key equal to the prior function.

   for item in priority:                                                                           # Checks if item is in the priority list.
